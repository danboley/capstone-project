...
function NavBar({ currentUser, updateUser }) {
  ...
  return (
    <header id="global-header" class="fixed top-0 left-0 right-0 bg-white h-14 leading-4 text-sm">
      <div className="h-14 relative border-b-2 border-gray-100 pl-12 pr-16">
        {currentUser ? (
          <div className="">
