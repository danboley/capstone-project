  ...
  return (
      <tr className="table-row" key={id}>
          <td className="table-cell px-4 py-2 text-left text-sm">{sport}</td>
              ...
              <td>
                <button className="table-cell px-4 py-2 text-center text-sm text-sky-600 hover:underline" onClick={(e) => {history.push(`/activities/${id}`)}}>Edit</button>
              </td>
              <td>
                <button className="table-cell px-4 py-2 text-center text-sm text-sky-600 hover:underline" onClick={handleDeleteInitial}>Delete</button>
              </td>
              <td>
                <select className="table-cell py-1 text-center text-sm" type="form-dropdown" key={id}>
                  Share
                  <option className="" value="" disabled selected hidden>Share</option>
